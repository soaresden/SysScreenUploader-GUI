...
jump:
    ...
    Private Sub ListBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListBox1.SelectedIndexChanged
        ...
        'Checking Name
        Dim nomdufichier As String = Path.GetFileName(chemindufichier)
        'looking for -
        Dim letiret As String = InStr(nomdufichier, "-")
        Dim gameid As String = Mid(nomdufichier.Substring(letiret), 1, (Len(nomdufichier.Substring(letiret)) - 4))
    ...
    Sub verifytitleid()
        For i = 0 To ListBox1.Items.Count - 1
            ...
            Dim usergamename As String = InputBox(gameid, "Checking GameID : What is this Game Name ? " & Chr(13) & "In the clipboard, Google It if you want")
